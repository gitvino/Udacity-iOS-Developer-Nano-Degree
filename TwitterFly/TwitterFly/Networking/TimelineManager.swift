...
class TimelineManager {
    ...
    func getHomeTimelineTweets(successHandler: @escaping(_ tweets: [Tweet]) -> Void,
        ...
        -> Void {
            ...
            timelineUrlComponents.path = Constants.URLConstants.statuses_path + Constants.URLConstants.home_timeline_path
